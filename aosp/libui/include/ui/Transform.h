...
class Transform
{
  public:
    ...
    // Returns if bilinear filtering is needed after applying this transform to
    // avoid aliasing.
    ...
    // for debugging
    void dump(std::string &result, const char *name,
...
inline constexpr Transform::RotationFlags
Transform::toRotationFlags(Rotation rotation)
{
    switch (rotation)
    {
    case ROTATION_0:
...
inline constexpr Rotation
Transform::toRotation(Transform::RotationFlags rotationFlags)
{
