               ...
               public TMatDebug<TMat22, T>
{
  ...
  public:
     ...
     *      \f$
     */
    template <typename U> explicit CONSTEXPR TMat22(U v);
     ...
     *      \f$
     */
    template <typename U> explicit CONSTEXPR TMat22(const TVec2<U> &v);

    /**
     * construct from another matrix of the same size
     */
    template <typename U> explicit CONSTEXPR TMat22(const TMat22<U> &rhs);
     ...
     */
    template <typename U> explicit CONSTEXPR TMat22(U const *rawArray);
...
template <typename T> CONSTEXPR TMat22<T>::TMat22()
{
    m_value[0] = col_type(1, 0);
    m_value[1] = col_type(0, 1);
}

template <typename T> template <typename U> CONSTEXPR TMat22<T>::TMat22(U v)
{
...
CONSTEXPR typename TMat22<U>::col_type PURE operator*(const TMat22<T> &lhs,
                                                      const TVec2<U> &rhs)
{
...
// vector
template <typename T, typename U>
CONSTEXPR typename TMat22<U>::row_type PURE operator*(const TVec2<U> &lhs,
                                                      const TMat22<T> &rhs)
{
...
template <typename T, typename U>
constexpr
    typename std::enable_if<std::is_arithmetic<U>::value, TMat22<T>>::type PURE
