...
// Non-cryptographic hash function (namely CityHash64) for strings with at most
// 64 characters. Unlike std::hash, which returns std::size_t and is only
// required to produce the same result for the same input within a single
// execution of a program, this hash is stable.
