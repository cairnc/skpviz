...
// Parse floating value in the string 's' and sets 'out' to that value if it
// exists. Optionally allows the caller to define a 'min' and 'max' beyond which
...
// Parse double value in the string 's' and sets 'out' to that value if it
// exists. Optionally allows the caller to define a 'min' and 'max' beyond which
// otherwise valid values will be rejected. Returns boolean success.
static inline bool
...
// Parse float value in the string 's' and sets 'out' to that value if it
// exists. Optionally allows the caller to define a 'min' and 'max' beyond which
// otherwise valid values will be rejected. Returns boolean success.
