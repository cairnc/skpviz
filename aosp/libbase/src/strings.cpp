...
// Wraps the posix version of strerror_r to make it available in translation
// units that define _GNU_SOURCE.
...
template std::string Join(const std::unordered_set<std::string> &,
                          const char *);
...
std::string StringReplace(std::string_view s, std::string_view from,
