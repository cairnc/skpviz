...
struct DisplayCreationArgs {
  ...
  // True if this display should be considered protected, as in this display
  // should render DRM content.
...
public:
  ...
  setHasPictureProcessing(bool hasPictureProcessing) {
    mArgs.hasPictureProcessing = hasPictureProcessing;
    return *this;
  }

  DisplayCreationArgsBuilder &
  setMaxLayerPictureProfiles(int32_t maxLayerPictureProfiles) {
    mArgs.maxLayerPictureProfiles = maxLayerPictureProfiles;
    return *this;
  }

  DisplayCreationArgsBuilder &
  setPowerAdvisor(adpf::PowerAdvisor *powerAdvisor) {
