...
public:
  ...
  void prepareFrame(bool usesClientComposition,
                    bool usesDeviceComposition) override;
  std::shared_ptr<renderengine::ExternalTexture>
  dequeueBuffer(base::unique_fd *bufferFence) override;
...
createRenderSurface(const compositionengine::CompositionEngine &,
