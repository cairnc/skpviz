...
class Display : public compositionengine::impl::Output,
                public virtual compositionengine::Display {
public:
  virtual ~Display();
  ...
  void createRenderSurface(
      const compositionengine::RenderSurfaceCreationArgs &) override;
  ...
  using ChangedTypes =
      android::HWComposer::DeviceRequestedChanges::ChangedTypes;
  using DisplayRequests =
      android::HWComposer::DeviceRequestedChanges::DisplayRequests;
  using LayerRequests =
      android::HWComposer::DeviceRequestedChanges::LayerRequests;
...
std::shared_ptr<BaseDisplay>
createDisplayTemplated(const CompositionEngine &compositionEngine,
...
createDisplay(const compositionengine::CompositionEngine &,
