...
class Display : public compositionengine::mock::Output,
                public compositionengine::Display {
public:
  Display();
  virtual ~Display();
  ...
  MOCK_METHOD1(createDisplayColorProfile,
               void(const DisplayColorProfileCreationArgs &));
