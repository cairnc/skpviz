 ...
 * Mock NativeWindow
 *
 * An intentionally simplified Mock which implements a minimal subset of the
 * full ANativeWindow interface.
 */
class NativeWindow
    : public ANativeObjectBase<ANativeWindow, NativeWindow, RefBase> {
public:
  NativeWindow();
  ~NativeWindow();
