...
void dumpHwc(const OutputLayerCompositionState::Hwc &hwc, std::string &out) {
  ...
  dumpVal(out, "composition", toString(hwc.hwcCompositionType),
          hwc.hwcCompositionType);
}
...
void OutputLayerCompositionState::dump(std::string &out) const {
  ...
  dumpVal(out, "override dataspace", toString(overrideInfo.dataspace),
          overrideInfo.dataspace);
  ...
  dumpVal(out, "override disableBackgroundBlur",
          overrideInfo.disableBackgroundBlur);
