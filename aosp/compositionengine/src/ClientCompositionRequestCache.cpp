...
getLayerSettingsSnapshot(const LayerFE::LayerSettings &settings) {
...
inline bool equalIgnoringBuffer(const renderengine::Buffer &lhs,
                                const renderengine::Buffer &rhs) {
...
bool layerSettingsAreEqual(const LayerFE::LayerSettings &lhs,
...
ClientCompositionRequestCache::ClientCompositionRequest::
...
bool ClientCompositionRequestCache::ClientCompositionRequest::equals(
  ...
  return newDisplay == display &&
         std::equal(layerSettings.begin(), layerSettings.end(),
                    newLayerSettings.begin(), newLayerSettings.end(),
                    layerSettingsAreEqual);
}
...
void ClientCompositionRequestCache::add(
    uint64_t bufferId, const renderengine::DisplaySettings &display,
