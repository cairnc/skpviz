...
std::unique_ptr<compositionengine::CompositionEngine>
...
CompositionEngine::createDisplay(const DisplayCreationArgs &args) {
...
void CompositionEngine::setRenderEngine(
    renderengine::RenderEngine *renderEngine) {
  mRenderEngine = renderEngine;
}

TimeStats *CompositionEngine::getTimeStats() const { return mTimeStats.get(); }

void CompositionEngine::setTimeStats(
...
FeatureFlags CompositionEngine::getFeatureFlags() const { return {}; }
