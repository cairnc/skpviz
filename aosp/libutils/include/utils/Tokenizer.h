...
class Tokenizer
{
  ...
  public:
    ...
    /**
     * Formats a location string consisting of the filename and current line
     * number. Returns a string like "MyFile.txt:33".
     */
    ...
    /**
     * Gets the remainder of the current line as a string, excluding the newline
     * character.
     */
     ...
     * Returns the token or an empty string if the current character is a
