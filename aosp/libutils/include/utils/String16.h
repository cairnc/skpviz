...
template <size_t N> class StaticString16;
...
class String16
{
  public:
    ...
    // Implicit cast to std::u16string is not implemented on purpose -
    // u16string_view is much lighter and if one needs, they can still create
    // u16string from u16string_view.
  ...
  protected:
     ...
     * visible to String16.
     */
    template <size_t N> struct StaticData
    {
        // The high bit of 'size' is used as a flag.
        static_assert(N - 1 < kIsSharedBufferAllocated,
                      "StaticString16 too long!");
...
// These symbols are for potential backward compatibility with prebuilts. To be
// removed.
 ...
 */
template <size_t N> class StaticString16 : public String16
{
  public:
