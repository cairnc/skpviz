...
template <typename KEY, typename VALUE>
inline bool
KeyedVector<KEY, VALUE>::isIdenticalTo(const KeyedVector<KEY, VALUE> &rhs) const
{
...
template <typename KEY, typename VALUE>
inline ssize_t KeyedVector<KEY, VALUE>::replaceValueFor(const KEY &key,
                                                        const VALUE &value)
{
...
template <typename KEY, typename VALUE>
inline ssize_t KeyedVector<KEY, VALUE>::replaceValueAt(size_t index,
                                                       const VALUE &item)
{
    if (index < size())
    {
...
template <typename KEY, typename VALUE>
inline ssize_t KeyedVector<KEY, VALUE>::removeItemsAt(size_t index,
                                                      size_t count)
{
...
template <typename KEY, typename VALUE>
inline const VALUE &
DefaultKeyedVector<KEY, VALUE>::valueFor(const KEY &key) const
{
    ssize_t i = this->indexOfKey(key);
    return i >= 0 ? KeyedVector<KEY, VALUE>::valueAt(static_cast<size_t>(i))
                  : mDefault;
}
