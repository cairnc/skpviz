...
struct RequestedLayerState : layer_state_t {
  // Changes in state after merging with new state. This includes additional
  // state changes found in layer_state_t::what.
  ...
  static constexpr ftl::Flags<Changes> kMustComposite =
      Changes::Created | Changes::Destroyed | Changes::Hierarchy |
      Changes::Geometry | Changes::Content | Changes::Input | Changes::Z |
      Changes::Mirror | Changes::Parent | Changes::RelativeParent |
      Changes::Metadata | Changes::Visibility | Changes::VisibleRegion |
      Changes::Buffer | Changes::SidebandStream | Changes::Animation |
      Changes::BufferSize | Changes::GameMode | Changes::BufferUsageFlags;
  ...
  // The owner of the layer. If created from a non system process, it will be
  // the calling uid. If created from a system process, the value can be passed
  // in.
  const gui::Uid ownerUid;
  // The owner pid of the layer. If created from a non system process, it will
  // be the calling pid. If created from a system process, the value can be
  // passed in.
  ...
  bool protectedByApp{
      false}; // application requires protected path to external sink
