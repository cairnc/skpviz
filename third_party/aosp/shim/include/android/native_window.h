...
// FRAME_RATE sentinels SF reaches through this header.
#define ANATIVEWINDOW_FRAME_RATE_NO_VOTE -1
#define ANATIVEWINDOW_FRAME_RATE_DEFAULT 0
#define ANATIVEWINDOW_FRAME_RATE_EXACT 1
#define ANATIVEWINDOW_FRAME_RATE_CATEGORY_NO_PREFERENCE 0
#define ANATIVEWINDOW_FRAME_RATE_CATEGORY_LOW 1
#define ANATIVEWINDOW_FRAME_RATE_CATEGORY_NORMAL 2
#define ANATIVEWINDOW_FRAME_RATE_CATEGORY_HIGH 3
#define ANATIVEWINDOW_FRAME_RATE_CATEGORY_HIGH_HINT 4
